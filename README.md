...
1. Clone the repo
   ```sh
   git clone https://github.com/makarandmadhavi/NU-Chronicles.git
   ```
2. Install NPM packages for frontend React server
   ```sh
   cd chronicle
   npm install
   ```
3. Install NPM packages backend server
   ```sh
   cd server
   npm install
   ```
...
1. Run frontend server
   ...
   npm start
   ```
2. Start backend server on a new terminal
   ```sh
   cd server
   npm run dev
   ```
